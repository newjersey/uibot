...
INSTRUCTIONS = f"""
    CONTEXT:
    This context information is about Temporary Disability and Family Leave Insurance.
    Today's date is {now}.
    Answer only if the question is relevant to provided context information.
